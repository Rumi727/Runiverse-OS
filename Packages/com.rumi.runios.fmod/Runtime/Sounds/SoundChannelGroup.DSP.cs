...
namespace RuniOS.Sounds
{
    ...
    {
        /// <summary>
        /// Attaches <paramref name="dsp"/> to this channel group's DSP chain.<br/>
        /// <paramref name="dsp"/>를 이 채널 그룹의 DSP 체인에 부착합니다.
        /// </summary>
        /// <param name="dsp">
        ...
        /// </param>
        /// <param name="index">
        /// Position where FMOD inserts DSP in this channel group's chain.<br/>
        /// FMOD가 이 채널 그룹 체인에서 DSP를 삽입할 위치입니다.
        /// </param>
        /// <remarks>
        ...
        public void AddDSP(DSP dsp, DSPIndex index = DSPIndex.tail)
        {
            ...
            try
            {
                ...
                dsp.UseNative(nativeDSP => native.addDSP((int)index, nativeDSP).ThrowIfNotOk());
            }
            finally
            {
        ...
        /// <summary>
        /// Detaches <paramref name="dsp"/> from this channel group's DSP chain.<br/>
        /// <paramref name="dsp"/>를 이 채널 그룹의 DSP 체인에서 분리합니다.
        /// </summary>
        /// <param name="dsp">
        /// DSP created by the same sound system.<br/>
        /// 같은 사운드 시스템에서 생성한 DSP입니다.
        ...
        public void RemoveDSP(DSP dsp)
        {
            ...
            {
                ThrowIfDisposedUnsafe();
                dsp.UseNative(nativeDSP => native.removeDSP(nativeDSP).ThrowIfNotOk());
            }
            finally
            {
                nativeLock.ExitReadLock();
