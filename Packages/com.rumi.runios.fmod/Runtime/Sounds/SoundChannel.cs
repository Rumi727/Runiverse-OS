...
namespace RuniOS.Sounds
{
    ...
    /// </summary>
    /// <remarks>
    /// FMOD owns the native channel lifetime. Native calls are passed through without synchronization and may fail after the channel stops or is stolen.<br/>
    ...
    /// FMOD가 네이티브 채널 수명을 소유합니다. 네이티브 호출은 동기화 없이 전달되며 채널이 중지되거나 steal된 뒤 실패할 수 있습니다.<br/>
