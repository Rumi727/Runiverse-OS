...
namespace RuniOS.Sounds
{
    public sealed partial class SoundChannel
    {
        ...
        public void AddDSP(DSP dsp, DSPIndex index = DSPIndex.tail)
        {
            ...
            dsp.UseNative((nativeDSP, native) => native.addDSP((int)index, nativeDSP).ThrowIfNotOkOfChannel(), native);
        }
        ...
        public void RemoveDSP(DSP dsp)
        {
            ...
            dsp.UseNative((nativeDSP, native) => native.removeDSP(nativeDSP).ThrowIfNotOkOfChannel(), native);
        }
    }
}
