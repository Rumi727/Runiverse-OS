...
{
    /// <summary>
    /// Provides a rich-text builder base for text renderers that can consume alignment and format information.<br/>
    /// 정렬 및 format 정보를 처리할 수 있는 텍스트 렌더러용 rich text 빌더 기본 클래스를 제공합니다.
    /// </summary>
    public abstract class FormattableRichTextBuilder : RichTextBuilder
    {
        ...
        /// <summary>
        /// Appends rich-text output for the concrete text type that can consume alignment and format information.<br/>
        /// 정렬 및 format 정보를 처리할 수 있는 구체 텍스트 타입의 rich text 출력을 추가합니다.
        /// </summary>
        /// <param name="builder">
        /// The destination string builder.<br/>
        /// 대상 문자열 빌더입니다.
