...
namespace RuniOS.Reflection
{
    ...
    public sealed class NullabilityInfo
    {
        ...
        public NullabilityInfo(Type type, NullabilityState readState, NullabilityState writeState, NullabilityInfo? elementType, ImmutableArray<NullabilityInfo> typeArguments)
        {
            this.type = type;
        ...
        /// </summary>
        public ImmutableArray<NullabilityInfo> genericTypeArguments { get; }
    }
}