...
public static class DecimalMath
{
    ...
    /// represents 2*PI
    /// </summary>
    const decimal PIx2 = 6.28318530717958647692528676655900576839433879875021M;
    ...
    /// represents PI/2
    /// </summary>
    const decimal PIdiv2 = 1.570796326794896619231321691639751442098584699687552910487M;

    /// <summary>
    /// represents PI/4
    /// </summary>
    const decimal PIdiv4 = 0.785398163397448309615660845819875721049292349843776455243M;
    ...
    /// log(10,E) factor
    /// </summary>
    const decimal Log10Inv = 0.434294481903251827651128918916605082294397005803666566114M;
    ...
    /// </summary>
    /// <param name="x"></param>
    static void TruncateToPeriodicInterval(ref decimal x)
    {
        while (x >= PIx2)
        {
