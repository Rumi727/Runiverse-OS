...
namespace RuniOS.Resource
{
    ...
    /// </summary>
    public sealed class AssetScope<TAsset> : IAssetScope<TAsset> where TAsset : notnull
    {
        /// <summary>
        ...
        /// <summary>
        /// 이 <see cref="AssetScope{T}"/>에 대한 참조를 <see cref="handle"/>에 반환하고, 관련된 리소스를 정리합니다.
        /// </summary>
        public void Dispose()
        {
        ...
        ~AssetScope() => Debug.RuntimeLogError(
            $"AssetScope for handle '{handle.node.path}' was finalized without being properly disposed.\n" +
