...
namespace RuniOS.Resource
{
    public sealed class AssetRegistryList : IList<AssetRegistry>, IReadOnlyList<AssetRegistry>
    {
        ...
        readonly Dictionary<string, AssetRegistry> internalListOfName = new();
        ...
        public void Add(AssetRegistry item)
        {
            if (!internalListOfType.ContainsKey(item.GetType()))
            {
                ...
                internalListOfName.Add(item.registryName, item);
        ...
        {
            internalListOfName.Remove(item.registryName);
        ...
        public bool FindOfName(string name, [NotNullWhen(true)] out AssetRegistry? value) => internalListOfName.TryGetValue(name, out value);
