...
namespace RuniOS.Resource
{
    ...
    /// </summary>
    /// <typeparam name="T">목표 리소스 타입 (예: Texture2D, AudioClip)</typeparam>
    [Serializable]
    public record struct AssetRef<T>(ResourceKey key) : IAssetRef
    {
        ...
        Type IAssetRef.targetAssetType => typeof(T);
        ...
        public async UniTask<AssetScope<T>?> LoadAsync() => await ResourceManager.LoadScopeAsync<T>(key);
    }
}