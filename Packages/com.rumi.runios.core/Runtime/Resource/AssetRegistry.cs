...
namespace RuniOS.Resource
{
    ...
    public abstract class AssetRegistry
    {
        ...
        /// </summary>
        public IReadOnlyDictionary<Identifier, IAssetHandle> assetHandles { get; }
        readonly Dictionary<Identifier, IAssetHandle> _assetHandles = new();
        ...
        /// <br/>이 메서드가 호출된 후부터 <see cref="RecordAssetHandle(Identifier, IAssetHandle)"/>을 호출할 수 있습니다.
        /// </summary>
        ...
        /// <br/>이번 트래킹 세션에서 <see cref="RecordAssetHandle(Identifier, IAssetHandle)"/>을 통해 등록되지 않은
        ...
        /// </exception>
        protected void RecordAssetHandle(Identifier identifier, IAssetHandle assetHandle)
        {
            if (!isTracking)
            ...
            if (!_assetHandles.TryGetValue(identifier, out IAssetHandle? value) || !value.IsSameTarget(assetHandle))
