...
namespace RuniOS.Json.Converters
{
    ...
    public class VersionConverter : JsonConverter<Version>
    {
        ...
        public override Version ReadJson(JsonReader reader, Type objectType, Version existingValue, bool hasExistingValue, JsonSerializer serializer) => reader.TokenType switch
        {
            JsonToken.Null => Version.all,
            JsonToken.String => new Version((string?)reader.Value ?? string.Empty),
            _ => throw new JsonReaderException($"Unexpected token type '{reader.TokenType}' when parsing Version.")
        };
    }
}