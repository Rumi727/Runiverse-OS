...
namespace RuniOS.IO
{
    ...
    public class FileIOHandler : IOHandler
    {
        ...
        public override UniTask<IEnumerable<string>> GetDirectories() => UniTask.FromResult(Directory.EnumerateDirectories(targetPath).Select(x =>
        {
        ...
        /// <exception cref="DirectoryNotFoundException">지정된 경로의 일부가 유효하지 않은 경우 발생합니다.</exception>
        /// <exception cref="IOException">I/O 오류가 발생한 경우 발생합니다.</exception>
        public override UniTask<IEnumerable<FilePath>> GetAllDirectories() => UniTask.FromResult(Directory.EnumerateDirectories(targetPath, "*", SearchOption.AllDirectories).Select(x => x - targetPath));
        ...
        /// <exception cref="DirectoryNotFoundException">지정된 경로의 일부가 유효하지 않은 경우 발생합니다.</exception>
        /// <exception cref="IOException">I/O 오류가 발생한 경우 발생합니다.</exception>
        public override UniTask<IEnumerable<string>> GetFiles() => UniTask.FromResult(Directory.EnumerateFiles(targetPath).Select(x =>
        {
            if (x.ToPath().TryTrimStartPath(targetPath, out FilePath result))
                return result.ToString();
        ...
        /// <exception cref="DirectoryNotFoundException">지정된 경로의 일부가 유효하지 않은 경우 발생합니다.</exception>
        /// <exception cref="IOException">I/O 오류가 발생한 경우 발생합니다.</exception>
        public override UniTask<IEnumerable<string>> GetFiles(WildcardPatterns wildcardPatterns) => UniTask.FromResult(DirectoryUtility.EnumerateFiles(targetPath, wildcardPatterns).Select(x =>
        {
        ...
        /// <exception cref="DirectoryNotFoundException">지정된 경로의 일부가 유효하지 않은 경우 발생합니다.</exception>
        /// <exception cref="IOException">I/O 오류가 발생한 경우 발생합니다.</exception>
        public override UniTask<IEnumerable<FilePath>> GetAllFiles() => UniTask.FromResult(Directory.EnumerateFiles(targetPath, "*", SearchOption.AllDirectories).Select(x => x - targetPath));
        ...
        /// <exception cref="DirectoryNotFoundException">지정된 경로의 일부가 유효하지 않은 경우 발생합니다.</exception>
        /// <exception cref="IOException">I/O 오류가 발생한 경우 발생합니다.</exception>
        public override UniTask<IEnumerable<FilePath>> GetAllFiles(WildcardPatterns wildcardPatterns) => UniTask.FromResult(DirectoryUtility.EnumerateFiles(targetPath, wildcardPatterns, SearchOption.AllDirectories).Select(x => x - targetPath));
        ...
        /// <exception cref="PathTooLongException">경로가 시스템 정의 최대 길이를 초과하는 경우 발생합니다.</exception>
        /// <exception cref="NotSupportedException">경로에 콜론(:)이 포함된 경우 발생합니다.</exception>
        public override UniTask<IEnumerable<string>> ReadLines() => UniTask.FromResult(File.ReadLines(targetPath));
