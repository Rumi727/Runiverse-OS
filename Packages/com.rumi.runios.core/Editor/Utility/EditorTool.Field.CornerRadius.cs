...
namespace RuniOS.Editor
{
    ...
    {
        public static CornerRadius CornerRadiusFieldLayout(CornerRadius value, AnimFloat animFloat, bool isInArray = false) => CornerRadiusField(EditorGUILayout.GetControlRect(), value, animFloat, isInArray);
        public static CornerRadius CornerRadiusFieldLayout(string label, CornerRadius value, AnimFloat animFloat, bool isInArray = false) => CornerRadiusField(EditorGUILayout.GetControlRect(), label, value, animFloat, isInArray);
        public static CornerRadius CornerRadiusFieldLayout(GUIContent label, CornerRadius value, AnimFloat animFloat, bool isInArray = false) => CornerRadiusField(EditorGUILayout.GetControlRect(), label, value, animFloat, isInArray);
