...
namespace RuniOS.Editor.Unity.Serialization
{
    ...
    public class PropertyConverterAttribute : TypeRegistrationAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyConverterAttribute"/> class.
        /// <br/>
        /// <see cref="PropertyConverterAttribute"/> 클래스의 새 인스턴스를 초기화합니다.
        /// </summary>
        ...
        /// </param>
        public PropertyConverterAttribute(Type targetType, bool useForChildren = false) : base(targetType) => this.useForChildren = useForChildren;
    }
}