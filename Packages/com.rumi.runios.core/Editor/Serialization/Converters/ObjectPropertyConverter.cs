...
{
    /// <summary>
    /// A concrete implementation of <see cref="PropertyConverter"/> that handles properties of type <see cref="object"/>.
    ...
    /// </summary>
    [CustomPropertyConverter(typeof(object), true, priority = int.MinValue)]
    public class ObjectPropertyConverter : PropertyConverter
    {
        ...
        public override object? Read(SerializedProperty property, Type propertyType) => property.boxedValue;
        ...
        public override void Write(SerializedProperty property, Type propertyType, object? value) => property.boxedValue = value;
    }
}
#endif