...
namespace RuniOS.Editor.IMGUI
{
    public static partial class RuniLayoutFields
    {
        ...
        public static AssetRef<T> AssetRefField<T>(GUIContent label, AssetRef<T> value, bool allowSceneObjects = false) where T : notnull => (AssetRef<T>)AssetRefField(label, (IAssetRef)value, allowSceneObjects);
