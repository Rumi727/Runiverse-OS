...
namespace RuniOS.Editor.IMGUI
{
    ...
    {
        public static AssetRef<T> AssetRefField<T>(Rect position, AssetRef<T> value) where T : notnull => (AssetRef<T>)AssetRefField(position, GUIContent.none, (IAssetRef)value);
        public static AssetRef<T> AssetRefField<T>(Rect position, string label, AssetRef<T> value) where T : notnull => (AssetRef<T>)AssetRefField(position, new GUIContent(label), (IAssetRef)value);
        public static AssetRef<T> AssetRefField<T>(Rect position, GUIContent label, AssetRef<T> value) where T : notnull => (AssetRef<T>)AssetRefField(position, new GUIContent(label), (IAssetRef)value);
