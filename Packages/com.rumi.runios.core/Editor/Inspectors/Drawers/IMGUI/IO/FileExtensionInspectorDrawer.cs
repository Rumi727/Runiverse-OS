...
{
    [InspectorDrawer(typeof(FileExtension))]
    ...
    {
        protected override object DrawField(Rect position, GUIContent label, object? value, DrawerContext context = default) => RuniFields.FileExtensionField(position, label, (FileExtension)value!);
    }
}