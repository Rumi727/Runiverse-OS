...
{
    [InspectorDrawer(typeof(Version))]
    ...
    {
        protected override object DrawField(Rect position, GUIContent label, object? value, DrawerContext context = default) => RuniFields.VersionField(position, label, (Version)value!);
