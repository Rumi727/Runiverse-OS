...
namespace RuniOS.Resource.NBS
{
    ...
    public sealed partial class NBSAssetRegistry : SimpleAssetRegistry<NBSAssetHandle>
    {
        ...
        protected override UniTask<NBSAssetHandle> CreateHandle(Identifier identifier, IONode node, FileMetaData fileMetaData) => UniTask.FromResult(new NBSAssetHandle(node, fileMetaData));
    }
}
