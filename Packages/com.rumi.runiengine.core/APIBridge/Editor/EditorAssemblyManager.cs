...
namespace RuniEngine.Editor.APIBridge
{
    internal static class EditorAssemblyManager
    {
        ...
        public static Assembly UnityEditor_UIElementsModule => _UnityEditor_UIElementsModule ??= assemblys.First(x => x.GetName().Name == "UnityEditor.UIElementsModule");
        static Assembly? _UnityEditor_UIElementsModule;

        public static Assembly UnityEditor_UIBuilderModule => _UnityEditor_UIBuilderModule ??= assemblys.First(x => x.GetName().Name == "UnityEditor.UIBuilderModule");
